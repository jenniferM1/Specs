#
# Be sure to run `pod lib lint Drive.podspec' to ensure this is a
...
mimik Drive allows developers to storage with various heterogeneous devices.
  ...
  s.source           = { :git => 'https://github.com/jenniferM1/MimikDrive.git', :tag => '1.2.0' }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.vendored_frameworks = 'Frameworks/Drive.framework'
